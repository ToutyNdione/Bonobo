    ...
    public function match($pathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/user')) {
            ...
            if ('/user' === $trimmedPathinfo) {
                ...
                return array (  '_controller' => 'BP\\BonoboBundle\\Controller\\UserController::indexAction',  '_route' => 'user_index',);
            }
            not_user_index:
            ...
            if ('/user/new' === $pathinfo) {
                ...
                return array (  '_controller' => 'BP\\BonoboBundle\\Controller\\UserController::newAction',  '_route' => 'user_new',);
            }
            not_user_new:
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_show')), array (  '_controller' => 'BP\\BonoboBundle\\Controller\\UserController::showAction',));
            }
            not_user_show:
            ...
            if (preg_match('#^/user/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_edit')), array (  '_controller' => 'BP\\BonoboBundle\\Controller\\UserController::editAction',));
            }
            not_user_edit:
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'bp_bonobo_homepage');
            }

            return array (  '_controller' => 'BP\\BonoboBundle\\Controller\\DefaultController::indexAction',  '_route' => 'bp_bonobo_homepage',);
        }
